...
public final class NotaInmutableImpl implements Nota{
	...
	public NotaInmutableImpl(Asignatura asignatura, Integer curso,Convocatoria convocatoria, Double valor, Boolean mencionHonor){
		checkValor(valor);
		checkMencionHonor(valor,mencionHonor);
		this.asignatura=copyAsignatura(asignatura);
	...
	public NotaInmutableImpl(Asignatura asignatura, Integer curso,Convocatoria convocatoria, Double valor){
		checkValor(valor);
		this.asignatura=copyAsignatura(asignatura);
		this.cursoAcademico= curso;
		this.convocatoria=convocatoria;
	...
	private Asignatura copyAsignatura(Asignatura a){
		//String nombre,String codigo, Double creditos, TipoAsignatura tipo,Integer curso,Departamento d
	...
	public Asignatura getAsignatura() {
		return copyAsignatura(asignatura);
	}
