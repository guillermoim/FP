...
public class TestBeca {
	...
	public static void main(String[] args) {
		...
		System.out.println(Grados.getBecasCreadas());
		System.out.println(Grados.getNumBecasCreadas());
		//System.out.println(Arrays.toString(Grados.getNumBecasTipo()));
	}
	
	
	private static void testOrder1(){
		Beca b1 = new BecaImpl("ABC1234",10000.0,6,TipoBeca.ORDINARIA);
		Beca b2 = new BecaImpl("ABC1234",10000.0,6,TipoBeca.EMPRESA);
		testOrder(b1,b2);
	}
	
	private static void testOrder(Beca b1, Beca b2){
		mostrarBeca(b1);
		mostrarBeca(b2);
		int cmp=b1.compareTo(b2);
		if(cmp==0){
			System.out.print("b1 and b2 are equal");
		}
		else if(cmp<0){
			System.out.print("b1 is lower than b2");
		}
		else{
			System.out.print("b1 is greater than b2");
		}
	}
		
	private static void testEquality1(){
		Beca b1 = new BecaImpl("ABC1234",10000.0,6,TipoBeca.EMPRESA);
		Beca b2 = new BecaImpl("ABC1234",10000.0,6,TipoBeca.ORDINARIA);
		testEquality(b1,b2);
		
	}
	
	private static void testEquality(Beca b1, Beca b2){
		mostrarBeca(b1);
		mostrarBeca(b2);
	...
	private static void testConstructor1Excepcion1() {
		System.out.println("==================================Probando el primer constructor, pocos caracteres en el código");
		testConstructor1("ABC12",10000.0,6,TipoBeca.ORDINARIA);
	}
	
	private static void testConstructor1Excepcion2() {
		System.out.println("==================================Probando el primer constructor, demasiados caracteres en el código");
		testConstructor1("ABC12345",10000.0,6,TipoBeca.ORDINARIA);
	}
	
	private static void testConstructor1Excepcion3() {
		System.out.println("==================================Probando el primer constructor, pocas letras en el código");
		testConstructor1("AB12345",10000.0,6,TipoBeca.ORDINARIA);
	}
	
	private static void testConstructor1Excepcion4() {
		System.out.println("==================================Probando el primer constructor, pocos dígitos en el código");
		testConstructor1("ABCD123",10000.0,6,TipoBeca.ORDINARIA);
	}
	
	private static void testConstructor1Excepcion5() {
		System.out.println("==================================Probando el primer constructor, cuantía total menor a la mínima");
	...
	private static void testConstructor2Excepcion1() {
		System.out.println("==================================Probando el segundo constructor, pocos caracteres en el código");
		testConstructor2("ABC12",TipoBeca.ORDINARIA);
	}
	
	private static void testConstructor2Excepcion2() {
		System.out.println("==================================Probando el segundo constructor, demasiados caracteres en el código");
		testConstructor2("ABC12345",TipoBeca.ORDINARIA);
	}
	
	private static void testConstructor2Excepcion3() {
		System.out.println("==================================Probando el segundo constructor, pocas letras en el código");
		testConstructor2("AB12345",TipoBeca.ORDINARIA);
	}
	
	private static void testConstructor2Excepcion4() {
		System.out.println("==================================Probando el segundo constructor, pocos dígitos en el código");
	...
	private static void testSetCuantiaTotalExcepcion1(){
		System.out.println("==================================Probando setCuantiaTotal con cuantía total menor a la mínima");
		Beca b = new BecaImpl("ABC1234",10000.0,6,TipoBeca.ORDINARIA);
